...
export default function Home({ setTab, history, initialStudents, alumnosAsignadosHoy, calculateStreak }) {
  ...
  return (
    <div className="home-screen">
      ...
      <div className="welcome-section" style={{
        ...
        <span className="privacy-badge" style={{ textTransform: 'capitalize', color: 'var(--text-orange-hover)', marginTop: '4px' }}>
          📅 {formattedDate}
        </span>
      ...
      {/* ================= SECCIÓN GRID INFRAESTRUCTURA ================= */}
      <div className="reports-grid-layout" style={{ gap: '24px' }}>
        
        {/* PODIO DE RACHAS (MOTIVACIÓN) */}
          ...
          {topStreaks.length === 0 ? (
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-end', gap: '20px', width: '100%', padding: '10px 0' }}>
              {topStreaks.map((s, index) => {
                // Orden visual clásico de podio: 2do lugar, 1er lugar, 3er lugar
